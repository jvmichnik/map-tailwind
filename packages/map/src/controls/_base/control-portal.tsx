...
const POSITION_CLASSES = {
  ...
  bottomrightSecondary: "leaflet-bottom-right-secondary",
  bottomleftSecondary: "leaflet-bottom-left-secondary",
};

export const ControlPortal = (props: Props): JSX.Element => {
  ...
  React.useEffect(() => {
    ...
    if (targetDiv.length > 0) {
      ...
      const topRightSecondary = document.createElement("div");
      topRightSecondary.classList.add("leaflet-bottom-right-secondary");
      container.append(topRightSecondary);
    }
  }, [positionClass]);
   ...
   */
  const className = (props.container?.className?.concat(" ") || "") + "";
